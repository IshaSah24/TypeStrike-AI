  ...
  <div className="w-full h-full flex items-center justify-center relative z-10 rounded-xl bg-gradient-to-br from-slate-900 via-black to-slate-900 overflow-hidden group-hover:scale-[1.02] transition-transform duration-500">
    ...
    <div className="relative flex items-center justify-center">
      <div className="relative">
        ...
        <div className="absolute top-0 right-0 w-1.5 h-1.5 bg-slate-400 rounded-full animate-ping opacity-75 group-hover:bg-slate-300"></div>
        <div className="absolute top-0 right-0 w-1.5 h-1.5 bg-slate-300 rounded-full shadow-[0_0_8px_rgba(148,163,184,0.8)] group-hover:shadow-[0_0_12px_rgba(226,232,240,1)]"></div>
      </div>
    </div>
  </div>
...
<div className="flex flex-col -space-y-1">
  <div className="flex items-baseline">
    <span className="text-base font-extralight text-slate-300 tracking-[0.1em] opacity-0 max-w-0 overflow-hidden group-hover:opacity-100 group-hover:max-w-[4rem] group-hover:tracking-[0.15em] transition-all duration-500">
      Type
    </span>
    ...
    <span className="text-base font-light text-slate-400 tracking-wide group-hover:text-slate-300 transition-colors duration-500">
      .Ai
    </span>
  </div>
